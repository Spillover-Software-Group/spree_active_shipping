module Spree
  module Calculator::Shipping
    module UspsRest
      class PriorityMailInternationalMediumFlatRateBox < Spree::Calculator::Shipping::UspsRest::Base
        ...
        def self.description
          I18n.t("usps_rest.priority_mail_international_medium_flat_rate_box")
        end
