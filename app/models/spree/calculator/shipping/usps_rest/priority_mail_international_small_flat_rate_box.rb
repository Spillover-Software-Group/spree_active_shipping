module Spree
  module Calculator::Shipping
    module UspsRest
      class PriorityMailInternationalSmallFlatRateBox < Spree::Calculator::Shipping::UspsRest::Base
        ...
        def self.description
          I18n.t("usps_rest.priority_mail_international_small_flat_rate_box")
        end
