module Spree
  module Calculator::Shipping
    module UspsRest
      class PriorityMailInternationalLargeFlatRateBox < Spree::Calculator::Shipping::UspsRest::Base
        ...
        def self.description
          I18n.t("usps_rest.priority_mail_international_large_flat_rate_box")
        end
