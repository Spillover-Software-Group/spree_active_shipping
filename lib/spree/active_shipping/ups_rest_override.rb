      ...
      def self.included(base)
        ...
        base.class_eval do
          ...
          def build_rate_request(origin, destination, packages, options = {})
            xml_builder = Nokogiri::XML::Builder.new do |xml|
              xml.RatingServiceSelectionRequest do
                ...
                xml.PickupType do
                  xml.Code(::ActiveShipping::UPSRest::PICKUP_CODES[pickup_type])
                  # not implemented: PickupType/PickupDetails element
                end

                cc = options[:customer_classification] || ::ActiveShipping::UPSRest::DEFAULT_CUSTOMER_CLASSIFICATIONS[pickup_type]
                xml.CustomerClassification do
                  xml.Code(::ActiveShipping::UPSRest::CUSTOMER_CLASSIFICATIONS[cc])
                end
                ...
                xml.Shipment do
                  ...
                  Array(packages).each do |package|
                    options[:imperial] ||= ::ActiveShipping::UPSRest::IMPERIAL_COUNTRIES.include?(origin.country_code(:alpha2))
          ...
          def parse_rate_response(origin, destination, packages, response, options={})
            ...
            if success
              rate_estimates = xml.root.css('> RatedShipment').map do |rated_shipment|
                ...
                ::ActiveShipping::RateEstimate.new(origin, destination, ::ActiveShipping::UPSRest.name,
          ...
          def find_time_in_transit(origin, destination, packages, options={})
            ...
            response = ssl_post("https://www.ups.com/ups.app/xml/TimeInTransit", rate_request)
